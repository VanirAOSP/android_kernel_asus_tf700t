...
static struct dvfs cpu_dvfs_table[] = {
    ...
    CPU_DVFS("cpu_g",  7, 1, MHZ, 480, 480, 650, 650,  780,  780,  990, 1040, 1100, 1200, 1300, 1300, 1400, 1400, 1500, 1600),
     CPU_DVFS("cpu_g",  7, 2, MHZ, 520, 520, 700, 700,  860,  860, 1050, 1150, 1200, 1300, 1300, 1400, 1400, 1500, 1600),
    CPU_DVFS("cpu_g",  7, 3, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1300, 1300, 1400, 1400, 1500, 1600),
    CPU_DVFS("cpu_g",  7, 4, MHZ, 550, 550, 770, 770,  940,  940, 1160, 1300, 1300, 1400, 1400, 1500, 1600),
#else
